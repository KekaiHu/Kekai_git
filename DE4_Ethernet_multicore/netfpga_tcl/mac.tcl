...
puts "MAC HI Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_MAC_1_HI_REG 1]";
master_write_32 $jtag_master $ROUTER_OP_LUT_MAC_1_LO_REG $MAC_1_LO;
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_MAC_1_LO_REG 1]";

# MAC_2 HI and LO
master_write_32 $jtag_master $ROUTER_OP_LUT_MAC_2_HI_REG $MAC_2_HI;
puts "MAC HI Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_MAC_2_HI_REG 1]";
master_write_32 $jtag_master $ROUTER_OP_LUT_MAC_2_LO_REG $MAC_2_LO;
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_MAC_2_LO_REG 1]";

# MAC_3 HI and LO
master_write_32 $jtag_master $ROUTER_OP_LUT_MAC_3_HI_REG $MAC_3_HI;
puts "MAC HI Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_MAC_3_HI_REG 1]";
master_write_32 $jtag_master $ROUTER_OP_LUT_MAC_3_LO_REG $MAC_3_LO;
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_MAC_3_LO_REG 1]";
