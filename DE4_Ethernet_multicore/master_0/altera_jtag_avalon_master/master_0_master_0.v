...
// 
// Generated using SOPC Builder version 11.0 157 at 2012.01.12.19:20:09

`timescale 1 ps / 1 ps
module master_0_master_0 #(
		parameter USE_PLI     = 0,
	...
	master_0_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	master_0_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~clk_reset_reset),                     // reset.reset_n
	...
	master_0_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~clk_reset_reset),                   // reset.reset_n
