...
# MAC
set REV_ADDRESS 				0x21000400;
set MAC_SCRATCH_ADDRESS 		0x21000404;
set COMMAND_CONFIG_ADDRESS		0x21000408;
set MAC_0_ADDRESS 				0x2100040C;
set MAC_1_ADDRESS 				0x21000410;
set FRM_LENGTH_ADDRESS 			0x21000414;
set PAUSE_QUANT_ADDRESS 		0x21000418;
set RX_SECTION_EMPTY_ADDRESS	0x2100041C;
set RX_SECTION_FULL_ADDRESS 	0x21000420;
set TX_SECTION_EMPTY_ADDRESS 	0x21000424;
set TX_SECTION_FULL_ADDRESS 	0x21000428;
set RX_ALMOST_EMPTY_ADDRESS 	0x2100042C;
set RX_ALMOST_FULL_ADDRESS 		0x21000430;
set TX_ALMOST_EMPTY_ADDRESS 	0x21000434;
set TX_ALMOST_FULL_ADDRESS 		0x21000438;
set MDIO_ADDR0_ADDRESS 			0x2100043C;
set MDIO_ADDR1_ADDRESS 			0x21000440;
set REG_STATUS_ADDRESS 			0x21000458;
set TX_IPG_LENGTH_ADDRESS 		0x2100045C;

set TX_CMD_STAT_ADDRESS 0x210004E8;
set RX_CMD_STAT_ADDRESS 0x210004EC;
...
master_write_32 $jtag_master 0x21000800 0x00000000;
