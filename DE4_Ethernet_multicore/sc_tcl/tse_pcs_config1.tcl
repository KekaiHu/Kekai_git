...
puts "TSE PCS read rev 		= [master_read_32 $jtag_master 0x21000644 1]";
puts "TSE PCS write scratch 	= $PCS_SCRATCH";
master_write_32 $jtag_master 0x21000640 $PCS_SCRATCH;
puts "TSE PCS read scratch 	= [master_read_32 $jtag_master 0x21000640 1]";


# PCS if_mode
set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000650 1];
...
master_write_32 $jtag_master 0x21000650 $tse_pcs_register_value_temp;
puts "TSE PCS read if_mode		= [master_read_32 $jtag_master 0x21000650 1]";


#### PCS Control Register
set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000600 1];
...
master_write_32 $jtag_master 0x21000600 $tse_pcs_register_value_temp;
puts "TSE PCS read control register	= [master_read_32 $jtag_master 0x21000600 1]";
...
while { ($tse_pcs_register_value_temp == 0x00000000) && ($PCS_COUNT_TEMP < $PCS_TIMEOUT) } {
	set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000604 1];
...
set tse_pcs_register_value_temp 0;
while { ($tse_pcs_register_value_temp == 0x00000000) && ($PCS_COUNT_TEMP < $PCS_TIMEOUT) } {
	set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000614 1];
