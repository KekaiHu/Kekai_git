...
if { $PHY_ENABLE == 1} {
	puts "Configure PHY.";	
	master_write_32 $jtag_master 0x21000040 $PHY_ADDR;
	set quad_phy_register_value_temp 0;
	
	#### PHY Control Register (REG 0)
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x21000280 1];
	...
	master_write_32 $jtag_master 0x21000280 $quad_phy_register_value_temp;
	...
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x21000290 1];
	...
	master_write_32 $jtag_master 0x21000290 $quad_phy_register_value_temp;
	# Applying Software Reset
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x21000280 1];
	set quad_phy_register_value_temp [expr {$quad_phy_register_value_temp | 0x8000}];
	master_write_32 $jtag_master 0x21000280 $quad_phy_register_value_temp;
	puts "PHY read AN Advertisement Register		= [master_read_32 $jtag_master 0x21000290 1]";



	#### PHY 1000BASE-T Control Register (REG 9)
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x210002A4 1];
	...
	master_write_32 $jtag_master 0x210002A4 $quad_phy_register_value_temp;
	# Applying Software Reset
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x21000280 1];
	set quad_phy_register_value_temp [expr {$quad_phy_register_value_temp | 0x8000}];
	master_write_32 $jtag_master 0x21000280 $quad_phy_register_value_temp;
	puts "PHY read 1000BASE-T Control Register		= [master_read_32 $jtag_master 0x210002A4 1]";

	#### PHY PHY Specific Control Register (REG 16)
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x210002C0 1];
	set quad_phy_register_value_temp [expr {$quad_phy_register_value_temp | 0xC000}];
	puts "Set PHY Synchronizing FIFO to maximum";

	master_write_32 $jtag_master 0x210002C0 $quad_phy_register_value_temp;
	# Applying Software Reset
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x21000280 1];
	set quad_phy_register_value_temp [expr {$quad_phy_register_value_temp | 0x8000}];
	master_write_32 $jtag_master 0x21000280 $quad_phy_register_value_temp;
	...
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x210002EC 1];
	...
	master_write_32 $jtag_master 0x210002EC $quad_phy_register_value_temp;
	# Applying Software Reset
	set quad_phy_register_value_temp [master_read_32 $jtag_master 0x21000280 1];
	set quad_phy_register_value_temp [expr {$quad_phy_register_value_temp | 0x8000}];
	master_write_32 $jtag_master 0x21000280 $quad_phy_register_value_temp;
	puts "PHY read Extended PHY Specific Status Register	= [master_read_32 $jtag_master 0x210002EC 1]";
	
	puts "PHY read Control Register			= [master_read_32 $jtag_master 0x21000280 1]";
	...
	while { ($quad_phy_register_value_temp == 0x00000000) && ($PHY_COUNT_TEMP < $PHY_TIMEOUT) } {
		set quad_phy_register_value_temp [master_read_32 $jtag_master 0x210002C4 1];
