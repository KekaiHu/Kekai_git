...
puts "TSE PCS read rev 		= [master_read_32 $jtag_master 0x21000A44 1]";
puts "TSE PCS write scratch 	= $PCS_SCRATCH";
master_write_32 $jtag_master 0x21000A40 $PCS_SCRATCH;
puts "TSE PCS read scratch 	= [master_read_32 $jtag_master 0x21000A40 1]";


# PCS if_mode
set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000A50 1];
...
master_write_32 $jtag_master 0x21000A50 $tse_pcs_register_value_temp;
puts "TSE PCS read if_mode		= [master_read_32 $jtag_master 0x21000A50 1]";


#### PCS Control Register
set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000A00 1];
...
master_write_32 $jtag_master 0x21000A00 $tse_pcs_register_value_temp;
puts "TSE PCS read control register	= [master_read_32 $jtag_master 0x21000A00 1]";
...
while { ($tse_pcs_register_value_temp == 0x00000000) && ($PCS_COUNT_TEMP < $PCS_TIMEOUT) } {
	set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000A04 1];
...
set tse_pcs_register_value_temp 0;
while { ($tse_pcs_register_value_temp == 0x00000000) && ($PCS_COUNT_TEMP < $PCS_TIMEOUT) } {
	set tse_pcs_register_value_temp [master_read_32 $jtag_master 0x21000A14 1];
