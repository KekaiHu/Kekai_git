...
# MAC
set REV_ADDRESS 				0x21000000;
set MAC_SCRATCH_ADDRESS 		0x21000004;
set COMMAND_CONFIG_ADDRESS		0x21000008;
set MAC_0_ADDRESS 				0x2100000C;
set MAC_1_ADDRESS 				0x21000010;
set FRM_LENGTH_ADDRESS 			0x21000014;
set PAUSE_QUANT_ADDRESS 		0x21000018;
set RX_SECTION_EMPTY_ADDRESS	0x2100001C;
set RX_SECTION_FULL_ADDRESS 	0x21000020;
set TX_SECTION_EMPTY_ADDRESS 	0x21000024;
set TX_SECTION_FULL_ADDRESS 	0x21000028;
set RX_ALMOST_EMPTY_ADDRESS 	0x2100002C;
set RX_ALMOST_FULL_ADDRESS 		0x21000030;
set TX_ALMOST_EMPTY_ADDRESS 	0x21000034;
set TX_ALMOST_FULL_ADDRESS 		0x21000038;
set MDIO_ADDR0_ADDRESS 			0x2100003C;
set MDIO_ADDR1_ADDRESS 			0x21000040;
set REG_STATUS_ADDRESS 			0x21000058;
set TX_IPG_LENGTH_ADDRESS 		0x2100005C;

set TX_CMD_STAT_ADDRESS 0x210000E8;
set RX_CMD_STAT_ADDRESS 0x210000EC;
...
master_write_32 $jtag_master 0x21000400 0x00000000;
