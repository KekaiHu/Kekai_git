...
# MAC
set REV_ADDRESS 				0x21000800;
set MAC_SCRATCH_ADDRESS 		0x21000804;
set COMMAND_CONFIG_ADDRESS		0x21000808;
set MAC_0_ADDRESS 				0x2100080C;
set MAC_1_ADDRESS 				0x21000810;
set FRM_LENGTH_ADDRESS 			0x21000814;
set PAUSE_QUANT_ADDRESS 		0x21000818;
set RX_SECTION_EMPTY_ADDRESS	0x2100081C;
set RX_SECTION_FULL_ADDRESS 	0x21000820;
set TX_SECTION_EMPTY_ADDRESS 	0x21000824;
set TX_SECTION_FULL_ADDRESS 	0x21000828;
set RX_ALMOST_EMPTY_ADDRESS 	0x2100082C;
set RX_ALMOST_FULL_ADDRESS 		0x21000830;
set TX_ALMOST_EMPTY_ADDRESS 	0x21000834;
set TX_ALMOST_FULL_ADDRESS 		0x21000838;
set MDIO_ADDR0_ADDRESS 			0x2100083C;
set MDIO_ADDR1_ADDRESS 			0x21000840;
set REG_STATUS_ADDRESS 			0x21000858;
set TX_IPG_LENGTH_ADDRESS 		0x2100085C;

set TX_CMD_STAT_ADDRESS 0x210008E8;
set RX_CMD_STAT_ADDRESS 0x210008EC;
...
master_write_32 $jtag_master 0x21000C00 0x00000000;
