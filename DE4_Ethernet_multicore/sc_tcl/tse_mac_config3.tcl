...
# MAC
set REV_ADDRESS 				0x21000C00;
set MAC_SCRATCH_ADDRESS 		0x21000C04;
set COMMAND_CONFIG_ADDRESS		0x21000C08;
set MAC_0_ADDRESS 				0x21000C0C;
set MAC_1_ADDRESS 				0x21000C10;
set FRM_LENGTH_ADDRESS 			0x21000C14;
set PAUSE_QUANT_ADDRESS 		0x21000C18;
set RX_SECTION_EMPTY_ADDRESS	0x21000C1C;
set RX_SECTION_FULL_ADDRESS 	0x21000C20;
set TX_SECTION_EMPTY_ADDRESS 	0x21000C24;
set TX_SECTION_FULL_ADDRESS 	0x21000C28;
set RX_ALMOST_EMPTY_ADDRESS 	0x21000C2C;
set RX_ALMOST_FULL_ADDRESS 		0x21000C30;
set TX_ALMOST_EMPTY_ADDRESS 	0x21000C34;
set TX_ALMOST_FULL_ADDRESS 		0x21000C38;
set MDIO_ADDR0_ADDRESS 			0x21000C3C;
set MDIO_ADDR1_ADDRESS 			0x21000C40;
set REG_STATUS_ADDRESS 			0x21000C58;
set TX_IPG_LENGTH_ADDRESS 		0x21000C5C;

set TX_CMD_STAT_ADDRESS 0x21000CE8;
set RX_CMD_STAT_ADDRESS 0x21000CEC;
...
master_write_32 $jtag_master 0x21001000 0x00000000;
