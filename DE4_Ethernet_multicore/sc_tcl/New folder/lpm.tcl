...
# LPM
set ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG 							0x2000048;
set ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG 						0x200004c;
set ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG 				0x2000050;
set ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG 				0x2000054;
set ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG 							0x200005c;
set ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG							0x2000058;
...
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG 1]";
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG 1]";
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG 1]";
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG 1]";
puts "MAC LO Address 0 \t \t = [master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG 1]";
...
master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG 1;
master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG 1;
master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG 1;
master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG 1;
master_read_32 $jtag_master $ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG 1;
