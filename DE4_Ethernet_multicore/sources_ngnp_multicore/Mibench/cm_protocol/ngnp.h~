...
#define PKT_DONE_REPEAT_BASE 0x40000000
...
#define pkt_repeat(a) *((volatile unsigned int *) (PKT_DONE_REPEAT_BASE)) = a
...
#define TCP_SRC_PORT          0x10000030
#define TCP_DST_PORT          0x10000032
#define TCP_SEQ_NO            0x10000034
#define TCP_ACK_NO            0x10000038
#define TCP_LENGTH            0x1000003A //danai
#define TCP_DATA_OFFSET       0x1000003C
#define TCP_WINDOW_SIZE       0x1000003E

#define memset(addr, data, len) \
	do { \
		for(temp_u32 = 0; temp_u32 < len; temp_u32++){ \
			*(addr + temp_u32) = *(data + temp_u32); \
		} \
	} while(0)
