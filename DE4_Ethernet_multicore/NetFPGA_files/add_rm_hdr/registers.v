...
`define ROUTER_OP_LUT_SRAM_IPTABLE_ENTRY_IP           6'h20
`define ROUTER_OP_LUT_SRAM_IPTABLE_ENTRY_MASK         6'h21
`define ROUTER_OP_LUT_SRAM_IPTABLE_ENTRY_NEXT_HOP_IP  6'h22
`define ROUTER_OP_LUT_SRAM_IPTABLE_ENTRY_OUTPUT_PORT  6'h23
`define ROUTER_OP_LUT_SRAM_IPTABLE_RD_ADDR            6'h24
`define ROUTER_OP_LUT_SRAM_IPTABLE_WR_ADDR            6'h25
`define ROUTER_OP_LUT_CONFLICT_CAM_VID                6'h26
`define ROUTER_OP_LUT_CONFLICT_CAM_ENTRY_IP           6'h27
`define ROUTER_OP_LUT_CONFLICT_CAM_ENTRY_MASK         6'h28
`define ROUTER_OP_LUT_CONFLICT_CAM_ENTRY_NEXT_HOP_IP  6'h29
`define ROUTER_OP_LUT_CONFLICT_CAM_ENTRY_OUTPUT_PORT  6'h2a
`define ROUTER_OP_LUT_CONFLICT_CAM_RD_ADDR            6'h2b
`define ROUTER_OP_LUT_CONFLICT_CAM_WR_ADDR            6'h2c
